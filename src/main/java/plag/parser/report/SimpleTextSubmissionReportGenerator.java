 ...
 *
 */
public class SimpleTextSubmissionReportGenerator implements SubmissionReportGenerator {
    ...
    public SimpleTextSubmissionReportGenerator(PrintStream out, Queue<String> queue,
    ...
    public void generateReport(SubmissionDetectionResult detResult) throws Exception {
        ...
        if (this.generateFileDetectionReports) {
            ...
            resultQueue.offer("File detection results");
    ...
    public void generateReport(List detResults, List submissions
            , HtmlPrintable configuration, HtmlPrintable statistics) throws Exception {
    ...
    /**
     * only stats report generator
     */
    public static class OnlyStatsReportGenerator implements ReportGenerator {
        private PrintStream out;
        private Queue resultQueue;
        public OnlyStatsReportGenerator(PrintStream out, Queue<String> resultQueue) {
            this.out = out;
        ...
        public void generateReport(DetectionResult detectionResult)
            ...
            resultQueue.offer("------------------------------------------------------------------------");
            resultQueue.offer(fileA+": tokens:"+tokensACount+", similarity:"+similarityA);
            resultQueue.offer(fileB+": tokens:"+tokensBCount+", similarity:"+similarityB);
            resultQueue.offer("matches:"+matchCount);
        }
